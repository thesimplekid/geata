...
Use [Geatafile.lightning](Geatafile.lightning) for an LDK receiver. To enable both
protocols, add `lightning_protocols x402 l402` and remove `authorization` from
`lightning_headers`. For L402 through a Cashu mint, use the configuration in the
